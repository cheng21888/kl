...
# ==================== 业务配置 ====================
HOT_KEYWORDS = ['电网设备', '特高压', '酿酒行业', '贵金属', '快手概念', 'Kimi概念','拼多多概念', '黄金概念','小红书概念', 'Kimi概念','文化传媒', 'BC电池','航天装备', '贵金属','HJT电池', '特高压']
HOT_CONCEPT_LIST = ['电网设备', '特高压', '酿酒行业', '贵金属', '快手概念', 'Kimi概念','拼多多概念', '黄金概念','小红书概念', 'Kimi概念','文化传媒', 'BC电池','航天装备', '贵金属','HJT电池', '特高压']
