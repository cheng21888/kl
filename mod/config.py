...
# ==================== 业务配置 ====================
HOT_KEYWORDS = ['商业航天', '华为概念', '军工', '军民融合', '5G概念', '国产芯片','半导体概念','小金属概念','新能源车','太阳能','HIT电池','钙钛矿电池','TOPCon电池','储能']
HOT_CONCEPT_LIST = ['商业航天', '华为概念', '军工', '军民融合', '5G概念', '国产芯片','半导体概念','小金属概念','新能源车','太阳能','HIT电池','钙钛矿电池','TOPCon电池','储能']
